          ...
          child: Row(
            children: [
              ...
              _buildTab(
                context: context,
                label: 'Awaited',
                count: counts?.awaitedCount ?? 0,
                isSelected: selectedFilter == OrderStatus.awaited,
                onTap: () => cubit.filterOrders(OrderStatus.awaited),
                responsive: responsive,
              ),
              responsive.isMobile ? 8.w : 12.w,
              _buildTab(
                context: context,
                label: 'Confirmed',
                count: counts?.confirmedCount ?? 0,
                isSelected: selectedFilter == OrderStatus.confirmed,
                onTap: () => cubit.filterOrders(OrderStatus.confirmed),
                responsive: responsive,
              ),
              responsive.isMobile ? 8.w : 12.w,
              _buildTab(
              ...
              _buildTab(
                context: context,
                label: 'Failed',
                count: counts?.failedCount ?? 0,
                isSelected: selectedFilter == OrderStatus.failed,
                onTap: () => cubit.filterOrders(OrderStatus.failed),
                responsive: responsive,
              ),
            ],
          ),
